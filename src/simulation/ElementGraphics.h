...
constexpr auto PSPEC_WAVE      = UINT32_C(0x00000400);
...
constexpr auto RENDER_EFFE     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | EFFECT | PMODE_SPARK | PMODE_FLARE | PMODE_LFLARE;
constexpr auto RENDER_FIRE     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_ADD | PMODE_BLEND | FIRE_ADD | FIRE_BLEND;
constexpr auto RENDER_SPRK     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_ADD | PMODE_BLEND | FIRE_SPARK;
constexpr auto RENDER_GLOW     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_GLOW | PMODE_ADD | PMODE_BLEND;
constexpr auto RENDER_BLUR     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_BLUR | PMODE_ADD | PMODE_BLEND;
constexpr auto RENDER_BLOB     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_BLOB | PMODE_ADD | PMODE_BLEND;
constexpr auto RENDER_BASC     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_FLAT | PMODE_ADD | PMODE_BLEND | EFFECT_LINES;
constexpr auto RENDER_NONE     = OPTIONS | PSPEC_STICKMAN | PSPEC_WAVE | PMODE_FLAT;
